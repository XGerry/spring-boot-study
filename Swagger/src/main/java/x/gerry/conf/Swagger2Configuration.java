...
public class Swagger2Configuration {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("x.gerry"))
                .paths(PathSelectors.any())
                .build();
    }

    private ApiInfo apiInfo() {
        Contact contact = new Contact("Gerry", "www.baidu.com", "xxxxxxx@qq.com");
        return new ApiInfoBuilder()
                .title("Spring Boot中使用Swagger2构建RESTful APIs")
                .description("更多详情请咨询XGerry")
                .termsOfServiceUrl("http://www.xgerry.com")
                .contact(contact)
                .version("1.0.0")
                .build();
    }
