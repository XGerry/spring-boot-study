...
public class LoggerHandlerAop {
    ...
    // 匹配x.gerry.service包及子包下的任何方法执行
    @Pointcut(value = "execution(* x.gerry.service.*.*(..))")
    public void log1() {
    }
    ...
    // 匹配任何返回值类型的x.gerry包及任何子包下的以add开头的参数为String类型的方法执行
    @Pointcut(value = "execution(* x.gerry..add*(String))")
    public void log6() {
    }

    // 匹配 OR、AND
    @Pointcut(value = "execution(* x.gerry.service.*.add*(int))")
    public void log7() {
    }

    // 匹配 OR、AND、
    @Pointcut(value = "execution(* x.gerry.service.*.add*(int)) OR execution(* x.gerry..add*(String))")
    public void log8() {
    }
    ...
    // 匹配指定类型内的方法执行--只能匹配类型
    @Pointcut(value = "within(x.gerry.service.order.Impl.OrderInfoServiceImpl)")
    public void logw1() {
    }

    // 匹配指定类型内的方法执行(包下所有的类)
    @Pointcut(value = "within(x.gerry.service.order.Impl.*)")
    public void logw2() {
    }
    ...
    // 匹配指定类型内的方法执行(包下所有的类)
    @Pointcut(value = "this(x.gerry.service.order.IOrderInfoService)")
    public void logt1() {
    }
    ...
    // 匹配指定类型内的方法执行(包下所有的类)
    @Pointcut(value = "target(x.gerry.service.order.IOrderInfoService)")
    public void logt2() {
    }
    ...
    @Pointcut(value = "@within(x.gerry.annotation.SelfBean)")
    public void logaw2() {
    }
    ...
    @Pointcut(value = "@annotation(x.gerry.annotation.SelfMethod)")
    public void logaa1() {
    }
